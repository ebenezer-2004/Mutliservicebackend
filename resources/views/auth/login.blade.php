...
<form action="{{ route('dologin') }}" method="post">
  ...
  <h4 class="text-center f-w-500 mb-3">Connexion</h4>

  <!-- Champ Email -->
  <div class="form-group mb-3">
    <input type="email" name="email" class="form-control @error('email') is-invalid @enderror" placeholder="Adresse email" value="{{ old('email') }}">
    @error('email')
